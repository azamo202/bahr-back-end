...
export const brands: Brand[] = [
  { id: 'b1', name: 'Bahr Alaloan Pro' },
  { id: 'b2', name: 'Bahr Alaloan Elite' },
  { id: 'b3', name: 'Bahr Alaloan Home' },
  { id: 'b4', name: 'Bahr Alaloan Studio' },
];
...
export const serviceCenters = [
  { id: 's1', name: 'Bahr Alaloan Service Center - Erbil', address: '100m Street, Near Ankawa Intersection, Erbil, Kurdistan Region', phone: '+964 750 123 4567' },
  { id: 's2', name: 'Bahr Alaloan Service Center - Baghdad', address: 'Al-Karada District, Street 52, Baghdad, Iraq', phone: '+964 770 234 5678' },
  { id: 's3', name: 'Bahr Alaloan Service Center - Sulaymaniyah', address: 'Salim Street, Opposite City Mall, Sulaymaniyah, Kurdistan Region', phone: '+964 770 345 6789' },
];
